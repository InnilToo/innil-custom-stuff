...
async function INJURY_POISON(
  ...
  if (!options) {
    ui.notifications.warn(
      "You have no items able to have this poison applied to them."
    );
    return null;
  }
  ...
  for (const term of roll.terms)
    if (term instanceof Die) term.options.flavor = "poison";
  ...
  const babData = babonus
    .createBabonus({
      ...
      type: "damage",
      description:
        "<p>You have poisoned this item. It will apply additional damage on the first hit you make with it.</p>",
