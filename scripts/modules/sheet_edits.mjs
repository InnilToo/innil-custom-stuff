...
export class INNIL_SHEET {
	...
	static create_dots = (sheet, html) => {
		...
		if (spell_slot_dots) {
			const options = ["pact", "spell1", "spell2", "spell3", "spell4", "spell5", "spell6", "spell7", "spell8", "spell9"];
	...
	static pretty_trait_selector = (selector, html, context) => {
		...
		if (["system.traits.languages", "system.traits.di", "system.traits.dr", "system.traits.dv", "system.traits.ci"].includes(selector.attribute)) {
