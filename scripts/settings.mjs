...
class ColorPickerSubmenu extends FormApplication {
	...
	getData() {
		...
		const defaults = {
			...
			color_equipped: "#31c431",
			color_not_equipped: "#9f9f94",
			color_prepared: "#d6e600",
			color_not_prepared: "#9f9f94",
			color_always_prepared: "#31c431",
			color_proficient: "#31c431",
			color_half_proficient: "#1aa5c1",
